...
public partial class Basic
{
        ...
        where T : unmanaged
    {
        ...
        return new Watcher<T>(this, _tick, baseAddress, offsets);
    }
        ...
        where T : unmanaged
    {
        ...
        return new ArrayWatcher<T>(length, this, _tick, baseAddress, offsets);
    }
    ...
    public IWatcher<string> MakeString(int length, ReadStringType stringType, nint baseAddress, params int[] offsets)
    {
        ...
        return new AslHelp.Memory.Monitoring.StringWatcher(length, stringType, this, _tick, baseAddress, offsets);
    }
}

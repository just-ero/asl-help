...
public interface IMemoryWriter
{
    ...
    void Write<T>(T value, nint baseAddress, params int[] offsets) where T : unmanaged;
    ...
    bool TryWrite<T>(T value, nint baseAddress, params int[] offsets) where T : unmanaged;
    ...
    void WriteArray<T>(ReadOnlySpan<T> values, nint baseAddress, params int[] offsets) where T : unmanaged;
    ...
    bool TryWriteArray<T>(ReadOnlySpan<T> values, nint baseAddress, params int[] offsets) where T : unmanaged;
}

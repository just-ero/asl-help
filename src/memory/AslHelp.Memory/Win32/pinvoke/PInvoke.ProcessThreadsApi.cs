...
internal static unsafe partial class PInvoke
{
    ...
    ///     <i><see href="https://learn.microsoft.com/windows/win32/api/processthreadsapi/nf-processthreadsapi-getexitcodethread">
    ...
    /// </returns>
    public static bool GetExitCodeThread(SafeThreadHandle threadHandle, out uint exitCode)
    {
        fixed (uint* pExitCode = &exitCode)
        {
            return GetExitCodeThread(threadHandle, pExitCode) != 0;
        }

        [DllImport(Kernel32, EntryPoint = nameof(GetExitCodeThread), ExactSpelling = true, SetLastError = true)]
    ...
    ///     For further information see:
    ///     <i><see href="https://learn.microsoft.com/windows/win32/api/processthreadsapi/nf-processthreadsapi-createremotethread">
    ...
    /// </returns>
    public static SafeThreadHandle CreateRemoteThread(
        ...
        out uint threadId)
    {
        ...
        [DllImport(Kernel32, EntryPoint = nameof(CreateRemoteThread), ExactSpelling = true, SetLastError = true)]
        [SuppressUnmanagedCodeSecurity]
        static extern SafeThreadHandle CreateRemoteThread(
            SafeProcessHandle hProcess,
            void* lpThreadAttributes,
            nuint dwStackSize,
            void* lpStartAddress,
    ...
    ///     For further information see:
    ///     <i><see href="https://learn.microsoft.com/windows/win32/api/processthreadsapi/nf-processthreadsapi-openprocess">
    ...
    ///     otherwise, <see langword="null"/>.
    /// </returns>
    public static SafeProcessHandle OpenProcess(uint processId, ProcessAccess desiredAccess, bool inheritHandle)
    {
        return OpenProcess((uint)desiredAccess, inheritHandle ? 1 : 0, processId);

        [DllImport(Kernel32, EntryPoint = nameof(OpenProcess), ExactSpelling = true, SetLastError = true)]
        [SuppressUnmanagedCodeSecurity]

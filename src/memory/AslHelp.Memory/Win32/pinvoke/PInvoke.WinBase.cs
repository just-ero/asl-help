...
internal static unsafe partial class PInvoke
{
    ...
    ///     <i><see href="https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-formatmessagew">
        ...
        void* arguments)
    {
        ...
        [DllImport(Kernel32, EntryPoint = nameof(FormatMessageW), ExactSpelling = true, SetLastError = true)]

...
/// <summary>
///     Specifies the type of the <see cref="SymbolInfo"/>.
/// </summary>
/// <remarks>
///     For further information see:
///     <i><see href="https://docs.microsoft.com/windows/win32/api/dbghelp/ns-dbghelp-symbol_infow#members">
...
{
    /// <summary>
    ///     The <see cref="SymbolInfo.Value"/> member is used.
    /// </summary>
    ValuePresent = 0x00001,

    /// <summary>
    ///     The symbol is a register. The <see cref="SymbolInfo.Register"/> member is used.
    /// </summary>
    Register = 0x00008,
